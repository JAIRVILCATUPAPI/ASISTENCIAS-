...
public DefaultTableModel mostrar (String buscar) {
  ...
  sql = "SELECT matricula.idmatricula, estudiante.idEstudiante, estudiante.identificacion, estudiante.Nombres,
    estudiante.Apellidos, grado.nombre AS nombre, grado.nivel, matricula.periodo, matricula.estado, grado.idgrado FROM
    estudiante INNER JOIN matricula ON estudiante.idEstudiante = matricula.idestudiante INNER JOIN grado ON matricula.idgrado = grado.idgrado WHERE 
    estudiante.apellidos LIKE ?";
  ...
  public boolean editar (dmatricula v){
    ...
    try {
      ...
      //------empieza 0 es codigo 1 el siguiente campo sucesivamente
